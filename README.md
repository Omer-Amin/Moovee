...
Moovee is ideal for incorporating animations into games where behaviour is desired but values cannot be pre-determined. An example is smooth camera panning to points changing in real time.
